...
namespace Microsoft.AzureStack.Services.Update.Common.Persistence.Provider.SQLite.Entities
{
    ...
    [DataContract]
    [Table("CacheEntry", SoftDeleteEnabled = true, SyncWithList = true, EnableAuditTrail = true)]
        ...
        where T : class, IEntity<string>, IVersionedEntity<string>, IExpirableEntity<string>
    {
        ...
        [Column("IsDeleted", SqlDbType.BigInt, NotNull = true)]
        ...
        [Column("AbsoluteExpiration", SqlDbType.Text)]
        ...
        [DataMember]
        [JsonProperty("data")]
        [Column("Data", SqlDbType.VarBinary, NotNull = true)]
        ...
        [Column("TypeName", SqlDbType.Text, NotNull = true)]
        ...
        [Column("AssemblyVersion", SqlDbType.Text, NotNull = true)]
        ...
        [DataMember]
        [JsonProperty("size")]
        [Column("Size", SqlDbType.BigInt, NotNull = true)]
