//-------------------------------------------------------------------------------
// <copyright file="PersistenceLogger.cs" company="Microsoft Corp.">
//     Copyright (c) Microsoft Corp. All rights reserved.
// </copyright>
//-------------------------------------------------------------------------------

namespace Microsoft.AzureStack.Services.Update.Common.Persistence.Provider.SQLite.Traces
{
    using System;
    ...
    public static class PersistenceLogger
    {
        ...
        /// <param name="callerMember">The member name of the caller (automatically populated)</param>
        /// <param name="callerLine">The line number of the caller (automatically populated)</param>
        public static void BulkOperationStop(string operation, long count, Stopwatch stopwatch,
            [CallerFilePath] string callerFile = "",
            [CallerMemberName] string callerMember = "",
            [CallerLineNumber] int callerLine = 0)
        {
